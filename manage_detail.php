...
//check lated rid
$sql2 = "SELECT rid, resname FROM recipes WHERE creator = '$name' ORDER BY rid DESC LIMIT 1";
$result2 = mysqli_query($db, $sql2);
$row2 = mysqli_fetch_array($result2);
$id = $row2['rid'];
$resname = $row2['resname'];
...
if (isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if ($title = '' || $rtext == '' || $photo == '' || $ing == '' || $disc == '' || $rid == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO full_recipy(title, title_text, image, ing_text, disc, rid) VALUES('$title','$rtext','$fnew','$ing','$disc','$rid')";  // store the submited data ino the database :images
                mysqli_query($db, $sql);
                                ...
                                <form class="form-horizontal" action='' method='post' enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6" name='title' id="typeahead" value="<?php echo $resname; ?>" disabled />
                                            </div>
                                        </div>
